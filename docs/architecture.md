...
- **Not yet started**: `website/api/trigger-demo.js` (the Vercel serverless relay), the website changes (`app.js`/`index.html`/`styles.css`/`.env.example`), the Vercel env-var handoff, and the addendum §25 acceptance script end to end. Stopping here per `CLAUDE.md` §4.9 to report this phase and wait for approval before continuing.
